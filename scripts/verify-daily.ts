...
// Extra runtime fields from an old caller cannot enable Hard daily mode.
const staleOptions = { era: 'alltime' as const, hardMode: true };
useGame.getState().startDaily(staleOptions);
game = useGame.getState();
