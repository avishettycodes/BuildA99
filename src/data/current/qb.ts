...
const POOLS: Record<string, Row[]> = {
  ari: [
    ...
    ['now-ari-minshew', 'Gardner Minshew II', '2026–', 'The mustache arrived in the desert to hold a clipboard for a while.', 86, 84, 84, 83, 82, 77, 83],
  ...
  atl: [
    ['now-atl-penix', 'Michael Penix Jr.', '2024–', 'That left arm is a whip, and both knees have already been rebuilt once.', 92, 85, 86, 76, 85, 78, 76],
  ...
  bal: [
    ['now-bal-lamar', 'Lamar Jackson', '2018–', 'Nobody has ever run this position like him, and now he throws it better too.', 93, 94, 90, 99, 99, 99, 96],
    ...
    ['now-bal-thompson', 'Skylar Thompson', '2026–', 'Skylar Thompson: Kansas State; 219 pounds, 88 throw power, BAL QB4.', 88, 79, 84, 72, 85, 70, 72],
  ],
  buf: [
  ...
  car: [
    ['now-car-young', 'Bryce Young', '2023–', 'Benched in September and playing the best football of his life by December.', 87, 87, 89, 86, 91, 80, 84],
  ...
  chi: [
    ['now-chi-caleb', 'Caleb Williams', '2024–', 'Paints his nails before games and throws ropes off his back foot when it breaks down.', 97, 87, 96, 94, 95, 88, 90],
  ...
  cin: [
    ...
    ['now-cin-johnson', 'Josh Johnson', '2026–', 'Josh Johnson: San Diego; 219 pounds, 84 throw power, CIN QB3.', 84, 76, 78, 75, 82, 68, 71],
  ],
  cle: [
    ...
    ['now-cle-gabriel', 'Dillon Gabriel', '2025–', 'Dillon Gabriel: Oregon; 205 pounds, 90 toughness, CLE QB4.', 84, 83, 82, 76, 86, 76, 80],
  ],
  dal: [
  ...
  gb: [
    ['now-gb-love', 'Jordan Love', '2020–', 'Sat behind a legend for three seasons, then looked like a natural.', 92, 90, 92, 84, 83, 86, 88],
  ...
  hou: [
    ...
    ['now-hou-mertz', 'Graham Mertz', '2026–', 'Graham Mertz: Florida; 212 pounds, 86 throw power, HOU QB3.', 86, 82, 80, 70, 80, 67, 71],
  ],
  ind: [
    ['now-ind-djones', 'Daniel Jones', '2025–', 'Danny Dimes got run out of New York and is winning games in blue again.', 87, 89, 86, 83, 87, 82, 88],
    ['now-ind-richardson', 'Anthony Richardson Sr.', '2023–', 'Ran for 200 yards in a game and completed 47 percent in the same month.', 96, 78, 86, 81, 95, 69, 72],
    ['now-ind-leonard', 'Riley Leonard', '2025–', 'Ran Notre Dame to a title game on his legs and a lot of nerve.', 89, 80, 84, 77, 88, 73, 73],
  ],
  jax: [
    ['now-jax-lawrence', 'Trevor Lawrence', '2021–', 'Generational everything, and 28 points down at halftime he actually delivered.', 92, 92, 90, 86, 91, 88, 90],
    ['now-jax-mullens', 'Nick Mullens', '2026–', 'Nick Mullens: Southern Miss; 210 pounds, 95 toughness, JAX QB2.', 84, 80, 81, 65, 76, 71, 78],
  ...
  lv: [
    ...
    ['now-lv-mendoza', 'Fernando Mendoza', '2026–', 'Went from Berkeley to Indiana to the first round in about eighteen months.', 91, 84, 87, 83, 87, 78, 82],
  ...
  lac: [
    ['now-lac-herbert', 'Justin Herbert', '2020–', 'Six foot six with a cannon, and he threw for 400 with broken rib cartilage.', 96, 92, 92, 88, 86, 93, 92],
  ...
  lar: [
    ...
    ['now-lar-bennett', 'Stetson Bennett IV', '2023–', 'Won two national titles as a walk on and then vanished for a whole season.', 87, 79, 82, 72, 90, 74, 76],
    ...
    ['now-lar-caldwell', 'Matthew Caldwell', '2026–', 'Matthew Caldwell: Texas; 209 pounds, 79 throw power, LAR QB4.', 79, 69, 72, 61, 72, 57, 64],
  ],
  mia: [
  ...
  min: [
    ...
    ['now-min-wentz', 'Carson Wentz', '2026–', 'Nearly won an MVP in 2017 and has been somebody\'s backup every year since.', 89, 80, 85, 77, 83, 77, 81],
    ['now-min-mccarthy', 'J.J. McCarthy', '2024–', 'Won 27 of 28 at Michigan and lost his rookie season to a knee.', 91, 84, 88, 80, 90, 69, 72],
  ],
  ne: [
    ['now-ne-maye', 'Drake Maye', '2024–', 'Third overall, and by year two he was throwing people open all over the field.', 94, 93, 96, 89, 89, 84, 90],
  ...
  no: [
    ['now-no-shough', 'Tyler Shough', '2025–', 'Played seven seasons of college football and broke a bone in three of them.', 92, 90, 88, 71, 85, 79, 78],
  ...
  nyg: [
    ['now-nyg-dart', 'Jaxson Dart', '2025–', 'Took the job in week four and ran somebody over on his first drive.', 88, 88, 86, 85, 88, 83, 85],
  ...
  nyj: [
    ['now-nyj-geno', 'Geno Smith', '2026–', 'Nobody wanted him for the better part of a decade and he starts at 35.', 88, 85, 86, 79, 83, 82, 82],
  ...
  pit: [
    ...
    ['now-pit-rudolph', 'Mason Rudolph', '2024–', 'Got in a helmet swinging brawl once and has been rehabilitating it ever since.', 86, 83, 83, 72, 72, 75, 79],
  ...
  sea: [
    ...
    ['now-sea-lock', 'Drew Lock', '2023–', 'Won a Sunday night game in relief and it was the highlight of his career.', 89, 81, 84, 72, 85, 74, 80],
  ...
  ten: [
    ['now-ten-ward', 'Cam Ward', '2025–', 'Went from no scholarship offers to first overall in five years.', 91, 83, 87, 86, 87, 75, 81],
  ...
  was: [
    ['now-was-daniels', 'Jayden Daniels', '2024–', 'Won Rookie of the Year and threw a Hail Mary that beat Chicago at the gun.', 92, 87, 89, 88, 95, 74, 82],
    ...
    ['now-was-kaliakmanis', 'Athan Kaliakmanis', '2026–', 'Rutgers arm who went undrafted and survived every cut this summer.', 87, 77, 82, 75, 81, 69, 78],
  ],
};
