 ...
 * the state can live in the Zustand store and be serialized to localStorage. A
 * closure-based PRNG cannot do either of those things.
 */
...
// Skips ambiguous characters so stored run keys remain easy to inspect while debugging.
const SEED_ALPHABET = 'ABCDEFGHJKLMNPQRSTUVWXYZ23456789';

/** A short hidden key for one run. */
